...
public class BusController {
    ...
    public ResponseEntity<Bus> deleteBusByBusIdHandler(@PathVariable Integer busId,@RequestParam(required = false) String key) throws BusException, AdminException{
    ...
    public ResponseEntity<List<Bus>> getBusesByBusTypeHandler(@PathVariable String busType) throws BusException{
